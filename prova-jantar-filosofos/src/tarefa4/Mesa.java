/**
 * Monitor que gerencia o acesso aos garfos, usando synchronized/wait/notifyAll.
 * Garante exclusão mútua e utiliza a Solução de Monitor para evitar deadlock/starvation.
 */
public class Mesa {
    ...
    public synchronized void pegarGarfos(int idFilosofo) throws InterruptedException {
        // O synchronized(this) implicitamente atua como o lock
        ...
        // 3. Se não pode comer (estado != COMENDO), espera
        // O while é CRUCIAL para evitar Notificação Perdida e Starvation
    ...
    public synchronized void largarGarfos(int idFilosofo) {
        ...
        // 1. Testa se os vizinhos podem comer agora e atualiza o estado deles
